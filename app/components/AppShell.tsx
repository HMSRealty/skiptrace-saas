    ...
    <div className="min-h-screen flex" style={{ background: 'var(--bg-base)' }}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 overflow-auto p-6">
          ...
          {activeView === 'new-trace' && <NewTraceView session={session} credits={credits} onTraceComplete={() => { fetchCredits(); setActiveView('history'); }} onBuyCredits={() => setActiveView('buy-credits')} />}
